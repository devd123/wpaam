...
/**
 * Abstract wpaam_Field_Type class.
 *
 * @abstract
 * @author      Alessandro Tesoro
 */
abstract class wpaam_Field_Type {
	...
	function __construct() {
		...
		add_filter( "wpaam/field/types", array( $this, 'get_field_types' ), 10, 1 );
		add_filter( "wpaam/field/types/classes", array( $this, 'get_field_classes' ), 11, 1 );

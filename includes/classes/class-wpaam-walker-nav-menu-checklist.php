<?php
/**
 * Create a set of wpaam specific links into the menu manager.
 *
 ...
 * @since 1.1.0
 */
class WPAAM_Walker_Nav_Menu_Checklist extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( ! in_array( array( 'wpaam-'. $item->post_excerpt .'-nav' ), $item->classes ) ) {
			$item->classes[] = 'wpaam-'. $item->post_excerpt .'-nav';
		}

...
/**
 * wpaam_Field_Type_Checkboxes Class
 *
 * @since 1.2.0
 */
class wpaam_Field_Type_Checkboxes extends wpaam_Field_Type {
	...
	*/
	public function __construct() {
		...
		$this->name             = _x( 'Checkboxes', 'field type name', 'wpaam' );
		// Field type name
...
new wpaam_Field_Type_Checkboxes;

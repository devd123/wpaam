...
/**
 * wpaam_Field_Type_Url Class
 *
 * @since 1.0.0
 */
class wpaam_Field_Type_Url extends wpaam_Field_Type {
	...
	*/
	public function __construct() {
		...
		$this->name             = _x( 'Url', 'field type name', 'wpaam' );
		// Field type name
		$this->type             = 'url';
		// Class of this field
	...
	public static function options() {
		...
		$options[] = array(
			'name'     => 'rel',
			'label'    => esc_html__( 'Nofollow', 'wpaam' ),
			'desc'     => esc_html__( 'Enable this option to specify that the search spiders should not follow this link.', 'wpaam' ),
			'type'     => 'checkbox',
		);
	...
	public static function output_html( $value, $field ) {
		...
		$nofollow = wpaam_get_serialized_field_option( $field->options, 'rel' );

...
/**
 * wpaam_Field_Type_Password Class
 *
 * @since 1.0.0
 */
class wpaam_Field_Type_Password extends wpaam_Field_Type {
	...
	public function __construct() {
		...
		$this->name              = _x( 'Password', 'field type name', 'wpaam' );
		// Field type name
		$this->type              = 'password';
		// Class of this field

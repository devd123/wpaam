...
/**
 * wpaam_Field_Type_Radio Class
 *
 * @since 1.2.0
 */
class wpaam_Field_Type_Radio extends wpaam_Field_Type {
	...
	*/
	public function __construct() {
		...
		$this->name             = _x( 'Radio buttons', 'field type name', 'wpaam' );
		// Field type name
		$this->type             = 'radio';
		// Class of this field

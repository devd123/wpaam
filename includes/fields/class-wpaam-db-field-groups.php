...
/**
 * wpaam_DB_Field_Groups Class
 *
 * @since 1.0.0
 */
class WPAAM_DB_Field_Groups extends WPAAM_DB {
	...
	*/
	public function __construct() {
		...
		$this->table_name  = $wpdb->prefix . 'wpaam_field_groups';
		$this->primary_key = 'id';
		$this->version     = '1.0';
	...
	*/
	public function get_groups( $args = array() ) {
		...
		$cache_key = md5( 'wpaam_field_groups_' . serialize( $args ) );

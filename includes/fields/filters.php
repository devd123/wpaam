 ...
 * @since 1.2.0
 */
function wpaam_adjust_website_meta_output( $value, $field ) {
...
add_filter( 'wpaam_get_the_field_value', 'wpaam_adjust_website_meta_output', 10, 2 );
...
add_filter( 'wpaam_get_the_field_value', 'wpaam_adjust_name_meta_output', 10, 2 );

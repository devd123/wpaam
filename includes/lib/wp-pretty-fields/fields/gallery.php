	...
	class WPPF_Gallery_Field extends Pretty_Fields {
		...
		static function normalize_field( $field ) {
			...
			$field = wp_parse_args( $field, array(
				'button_create'  => __('Add/Edit Gallery', 'wpaam'),
				'button_delete'  => __('Delete Gallery', 'wpaam'),
				'frame_title'    => __('Select or upload images to create a gallery', 'wpaam'),
				'frame_button'   => __('Insert gallery', 'wpaam'),
				'delete_message' => __('Are you sure you want to delete the gallery?', 'wpaam')				
			) );

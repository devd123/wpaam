<?php
/**
 * wpaam Template: Uploaded content template.
 *
...
<div class="wpaam-uploaded-file">
	...
	if ( 3 !== strlen( $extension ) || in_array( $extension, array( 'jpg', 'gif', 'png', 'jpeg', 'jpe' ) ) ) : ?>
		<span class="wpaam-uploaded-file-preview"><img src="<?php echo esc_url( $value ); ?>" /></span>
	<?php else : ?>
		<span class="wpaam-uploaded-file-name"><code><?php echo esc_html( basename( $value ) ); ?></code></span>
	<?php endif; ?>

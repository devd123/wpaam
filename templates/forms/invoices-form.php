<?php
/**
 * WPAAM Template: Invoices Form Template.
 *
 * Displays Invoices edit form.
 *
...
<div id="wpaam-form-profile" class="wpaam-profile-form-wrapper">
	...
	<?php do_action( 'wpaam_before_invoices_form', $atts ); ?>

	<form action="#" method="post" id="wpaam-invoices" class="wpaam-invoices-form" name="wpaam-invoices" enctype="multipart/form-data">

		<?php do_action( 'wpaam_top_invoices_form', $atts ); ?>
		...
		<?php do_action( 'wpaam_bottom_invoices_form', $atts ); ?>
		...
		<p class="wpaam-submit">
			...
			<input type="submit" id="submit_wpaam_invoices" name="submit_wpaam_invoices" class="button" value="<?php _e( 'Update Settings', 'wpaam' ); ?>" />
		</p>

	</form>

	<?php do_action( 'wpaam_after_invoices_form', $atts ); ?>

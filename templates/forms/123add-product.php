...
?>
	...
	<?php elseif ( is_user_logged_in() && current_user_can( 'edit_product' ) && current_user_can( 'publish_product' ) ) : ?>
		...
		<form id="aam-product-type" name="aam-product-type" method="post" action="">
			...
			<input type="text" id="post_title" tabindex="3" name="post_title" value="" /></textarea>
			 
			</p>

			<p><label for="sku">Product SKU</label><br />
			 
			<input type="text" id="product_sku"  tabindex="1" name="product_sku" value=""/>
			...
			<input type="text"  tabindex="4" name="product_price" id="product_price" value="" /></p>

...
<div id="wpaam-form-profile" class="wpaam-profile-form-wrapper">
	...
	<?php do_action( 'wpaam_before_payments_form', $atts ); ?>

	<form action="#" method="post" id="wpaam-payments" class="wpaam-payments-form" name="wpaam-payments" enctype="multipart/form-data">

		<?php do_action( 'wpaam_top_payments_form', $atts ); ?>
		...
		<?php do_action( 'wpaam_bottom_payments_form', $atts ); ?>
		...
		<p class="wpaam-submit">
			...
			<input type="submit" id="submit_wpaam_payments" name="submit_wpaam_payments" class="button" value="<?php _e( 'Update Payment', 'wpaam' ); ?>" />
		</p>

	</form>

	<?php do_action( 'wpaam_after_payments_form', $atts ); ?>
